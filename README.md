# SigmaTrade - Мониторинг семейства торговых ботов
...
SigmaTrade - это профессиональная платформа для мониторинга семейства торговых ботов в реальном времени. Проект отслеживает работу трёх ботов: робота обмена, робота арбитража и МЭФ-робота. Использует QuickNode для подключения к Binance Smart Chain и предоставляет удобный интерфейс оператора.

## 🤖 Семейство ботов

- **🔄 Робот обмена** - автоматический обмен криптовалют
- **📊 Робот арбитража** - арбитраж между биржами
- **💼 МЭФ Робот** - МЭФ-деятельность

## ✨ Возможности v2.0.0

### 🆕 Новое в v2.0.0
- 🤖 **Визуализация ботов** - отображение статуса всех трёх ботов
